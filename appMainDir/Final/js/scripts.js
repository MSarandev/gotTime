...
function clickMeFilms(){
  ...
  if(count === 0){
    ...
    col1btn1.innerHTML =
    '<a href="#generated-modal" data-toggle="modal" id="ModalFilms1" onclick="fetchFilmByGenre(film_genres[0])">' +
    '<i id="FilmGanreIcon1" class="glyphicon glyphicon-map-marker"></i>' +
    '<p id="war_films">'+film_genres[0]+'</p>' +
    '</a>';


    // Update FILMS COL 1, BTN 2
    // -------------------
    col1btn2.innerHTML =
    '<a href="#generated-modal" data-toggle="modal" id="ModalFilms2" onclick="fetchFilmByGenre(film_genres[1])">' +
    '<i id="FilmGanreIcon2" class="glyphicon glyphicon-heart-empty"></i>' +
    '<p id="romantic_films">'+film_genres[1]+'</p>' +
    '</a>';

    // Update FILMS COL 1, BTN 3
    // -------------------
    col1btn3.innerHTML =
    '<a href="#generated-modal" data-toggle="modal" id="ModalFilms3" onclick="fetchFilmByGenre(film_genres[2])">' +
    '<i id="FilmGanreIcon3" class="glyphicon glyphicon-record"></i>' +
    '<p id="thriller_films">'+film_genres[2]+'</p>' +
    '</a>';

    // ...
    // Update FILMS COL 2, BTN 1
    // -------------------
    col2btn1.innerHTML =
    '<a href="#generated-modal" data-toggle="modal" id="ModalFilms4" onclick="fetchFilmByGenre(film_genres[3])">' +
    '<i id="FilmGanreIcon4" class="glyphicon glyphicon-fire"></i>' +
    '<p id="horror_films">'+film_genres[3]+'</p>' +
    '</a>';

    // Update FILMS COL 2, BTN 2
    // -------------------
    col2btn2.innerHTML =
    '<a href="#generated-modal" data-toggle="modal" id="ModalFilms5" onclick="fetchFilmByGenre(film_genres[4])">' +
    '<i id="FilmGanreIcon5" class="glyphicon glyphicon-film"></i>' +
    '<p id="western_films">'+film_genres[4]+'</p>' +
    '</a>';

    // Update FILMS COL 2, BTN 3
    // -------------------
    col2btn3.innerHTML =
...
function fetchFilmByGenre(x){
  ...
  // Placeholder below
  //document.getElementById("ModalFilms1").setAttribute("href", "#generated-modal");
  //document.getElementById("ModalFilms2").setAttribute("href", "#generated-modal");
  //document.getElementById("ModalFilms3").setAttribute("href", "#generated-modal");
  //document.getElementById("ModalFilms4").setAttribute("href", "#generated-modal");
  //document.getElementById("ModalFilms5").setAttribute("href", "#generated-modal");
}
...
function clickMeMusic(){
  ...
  if(count === 0){
    ...
    // 4. Parse (1) to the genre selector modal
    col1btn1.innerHTML =
    '<a href="#generated-modal"" data-toggle="modal" id="ModalMusic1" onclick="outputSongByGenre(selectedMusicGenres[0])">' +
    '<i id="MusicGanreIcon1" class="fa fa-fire"></i>' +
    '<p id="music1">' + selectedMusicGenres[0].name + '</p>' +
    '</a>';

    // Update MUSIC COL 1, BTN 2
    // -------------------
    col1btn2.innerHTML =
    '<a href="#generated-modal"" data-toggle="modal" id="ModalMusic2" onclick="outputSongByGenre(selectedMusicGenres[1])">' +
    '<i id="MusicGanreIcon2" class="glyphicon glyphicon-sound-7-1"></i>' +
    '<p id="music2">' + selectedMusicGenres[1].name + '</p>' +
    '</a>';

    // Update MUSIC COL 1, BTN 3
    // -------------------
    col1btn3.innerHTML =
    '<a href="#generated-modal"" data-toggle="modal" id="ModalMusic3" onclick="outputSongByGenre(selectedMusicGenres[2])">' +
    '<i id="MusicGanreIcon3" class="glyphicon glyphicon-stats"></i>' +
    '<p id="music3">' + selectedMusicGenres[2].name + '</p>' +
    '</a>';

    // ...
    // Update MUSIC COL 2, BTN 1
    // -------------------
    col2btn1.innerHTML =
    '<a href="#generated-modal"" data-toggle="modal" id="ModalMusic4" onclick="outputSongByGenre(selectedMusicGenres[3])">' +
    '<i id="MusicGanreIcon4" class="glyphicon glyphicon-music"></i>' +
    '<p id="music4">' + selectedMusicGenres[3].name + '</p>' +
    '</a>';

    // Update MUSIC COL 2, BTN 2
    // -------------------
    col2btn2.innerHTML =
    '<a href="#generated-modal"" data-toggle="modal" id="ModalMusic5" onclick="outputSongByGenre(selectedMusicGenres[4])">' +
    '<i id="MusicGanreIcon5" class="fa fa-microphone"></i>' +
    '<p id="music5">' + selectedMusicGenres[4].name + '</p>' +
    '</a>';

    // Update MUSIC COL 2, BTN 3
    // -------------------
    col2btn3.innerHTML =
    '<a href="#" data-toggle="modal" id="BackBtnA"' +
    '<i id="BackBtnIcon" class="fa fa-xing-square"></i>' +
...
//WIP - not used ATM (and probably later as well)
function fetchMusicByGenre(g){
  // THIS SHOULD LOAD A DYNAMIC MODAL BASED ON THE GENRE
	//document.getElementById('generatedResult').innerHTML = g.name;
	outputSongByGenre(g);
  // Placeholder below
  //document.getElementById("ModalMusic1").setAttribute("href", "#generated-modal");
  //document.getElementById("ModalMusic2").setAttribute("href", "#generated-modal");
  //document.getElementById("ModalMusic3").setAttribute("href", "#generated-modal");
  //document.getElementById("ModalMusic4").setAttribute("href", "#generated-modal");
  //document.getElementById("ModalMusic5").setAttribute("href", "#generated-modal");
}
...
function clickMeBooks(){
  ...
  if(count === 0){
    ...
    // 4. Parse (1) to the genre selector modal
    col1btn1.innerHTML =
    '<a href="#books-modal" data-toggle="modal" id="ModalBooks1" onclick="fetchBooksByGenre(books_genres[0])">' +
    '<i id="BooksGanreIcon1" class="fa fa-pagelines"></i>' +
    '<p id="books1">'+books_genres[0]+'</p>' +
    '</a>';


    // Update BOOKS COL 1, BTN 2
    // -------------------
    col1btn2.innerHTML =
    '<a href="#books-modal" data-toggle="modal" id="ModalBooks2" onclick="fetchBooksByGenre(books_genres[1])">' +
    '<i id="BooksGanreIcon2" class="glyphicon glyphicon-heart-empty"></i>' +
    '<p id="books2">'+books_genres[1]+'</p>' +
    '</a>';

    // Update BOOKS COL 1, BTN 3
    // -------------------
    col1btn3.innerHTML =
    '<a href="#books-modal" data-toggle="modal" id="ModalBooks3" onclick="fetchBooksByGenre(books_genres[2])">' +
    '<i id="BooksGanreIcon3" class="fa fa-puzzle-piece"></i>' +
    '<p id="books3">'+books_genres[2]+'</p>' +
    '</a>';

    // ...
    // Update BOOKS COL 2, BTN 1
    // -------------------
    col2btn1.innerHTML =
    '<a href="#books-modal" data-toggle="modal" id="ModalBooks4" onclick="fetchBooksByGenre(books_genres[3])">' +
    '<i id="BooksGanreIcon4" class="fa fa-eye-slash"></i>' +
    '<p id="books4">'+books_genres[3]+'</p>' +
    '</a>';

    // Update BOOKS COL 2, BTN 2
    // -------------------
    col2btn2.innerHTML =
    '<a href="#books-modal" data-toggle="modal" id="ModalBooks5" onclick="fetchBooksByGenre(books_genres[4])">' +
    '<i id="BooksGanreIcon5" class="fa fa-magic"></i>' +
    '<p id="books5">'+books_genres[4]+'</p>' +
    '</a>';

    // Update BOOKS COL 2, BTN 3
    // -------------------
    col2btn3.innerHTML =
    '<a href="#" data-toggle="modal" id="BackBtnA"' +
    '<i id="BackBtnIcon" class="fa fa-xing-square"></i>' +
...
function clickMeVideo(){
  if(count === 0){
    ...
    // 4. Parse (1) to the genre selector modal
    col1btn1.innerHTML =
    '<a href="#generated-modal" data-toggle="modal" id="ModalVideo1" onclick="fetchVideoByGenre(1)">' +
    '<i id="VideoGanreIcon1" class="glyphicon glyphicon-certificate"></i>' +
    '<p id="video1">Sports</p>' +
    '</a>';


    // Update VIDEOS COL 1, BTN 2
    // -------------------
    col1btn2.innerHTML =
    '<a href="#generated-modal" data-toggle="modal" id="ModalVideo2" onclick="fetchVideoByGenre(2)">' +
    '<i id="VideoGanreIcon2" class="glyphicon glyphicon-wrench"></i>' +
    '<p id="video2">DIY</p>' +
    '</a>';

    // Update VIDEOS COL 1, BTN 3
    // -------------------
    col1btn3.innerHTML =
    '<a href="#generated-modal" data-toggle="modal" id="ModalVideo3" onclick="fetchVideoByGenre(3)">' +
    '<i id="VideoGanreIcon3" class="fa fa-bug"></i>' +
    '<p id="video3">Science</p>' +
    '</a>';

    // ...
    // Update VIDEOS COL 2, BTN 1
    // -------------------
    col2btn1.innerHTML =
    '<a href="#generated-modal" data-toggle="modal" id="ModalVideo4" onclick="fetchVideoByGenre(4)">' +
    '<i id="VideoGanreIcon4" class="fa fa-pencil"></i>' +
    '<p id="video4">Beauty</p>' +
    '</a>';

    // Update VIDEOS COL 2, BTN 2
    // -------------------
    col2btn2.innerHTML =
    '<a href="#generated-modal" data-toggle="modal" id="ModalVideo5" onclick="fetchVideoByGenre(5)">' +
    '<i id="VideoGanreIcon5" class="fa fa-microphone"></i>' +
    '<p id="video5">Cover</p>' +
    '</a>';

    // Update VIDEOS COL 2, BTN 3
    // -------------------
    col2btn3.innerHTML =
    '<a href="#" data-toggle="modal" id="BackBtnA"' +
    '<i id="BackBtnIcon" class="fa fa-xing-square"></i>' +
...
function fetchVideoByGenre(x){
  ...
  // Placeholder below
  //document.getElementById("ModalVideo1").setAttribute("href", "#generated-modal");
  //document.getElementById("ModalVideo2").setAttribute("href", "#generated-modal");
  //document.getElementById("ModalVideo3").setAttribute("href", "#generated-modal");
  //document.getElementById("ModalVideo4").setAttribute("href", "#generated-modal");
  //document.getElementById("ModalVideo5").setAttribute("href", "#generated-modal");
}
